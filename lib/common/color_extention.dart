...
class TColor {
  ...
  // static Color get primary => const Color(0xff008080);
  // static Color get primary => const Color(0xff4169E1);
  // static Color get primary => const Color(0xffFFC0CB);
  static Color get primary => const Color(0xff7B68EE);
